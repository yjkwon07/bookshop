package com.yjkwon.bookshop.goods.vo;
...
public class GoodsVO {
	...
	public String getGoods_satus() {
		return goods_satus;
	}
	public void setGoods_satus(String goods_satus) {
		this.goods_satus = goods_satus;
	}
